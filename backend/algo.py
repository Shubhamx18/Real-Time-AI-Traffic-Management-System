...
def optimize_traffic(cars):
    ...
    # Also include vehicle counts (road density)
    result = {
        ...
        'max_density_road': ['north', 'south', 'west', 'east'][np.argmax(cars)]
    }

    print('Optimal Solution:')
    print(f'North Green Time = {result["north"]} seconds (Vehicles: {result["vehicle_counts"]["north"]})')
    print(f'South Green Time = {result["south"]} seconds (Vehicles: {result["vehicle_counts"]["south"]})')
    print(f'West Green Time = {result["west"]} seconds (Vehicles: {result["vehicle_counts"]["west"]})')
    print(f'East Green Time = {result["east"]} seconds (Vehicles: {result["vehicle_counts"]["east"]})')
    print(f'Maximum density road: {result["max_density_road"]}')
